...
class LoanProcessing:
    ...
    def incoming_data_process(self, loan_application_model : LoanApplicationModel):
        ...
        #customer_type = loan_application_model.CustomerType
        ...
        has_secondary_applicant = loan_application_model.HasSecondaryApplicant
        ...
        sec_app_fico_range_low = loan_application_model.SecAppFicoRangeLow
        sec_app_revol_util = loan_application_model.SecAppRevolUtil
        ...
        if(has_secondary_applicant == 'Yes'):
            ...
            if(sec_app_fico_range_low >= 500 and sec_app_revol_util < 30):
                sec_app_worth = 3
            elif(sec_app_fico_range_low >= 500 and sec_app_revol_util >= 30):
                sec_app_worth = 2
            elif(sec_app_fico_range_low < 500 and sec_app_revol_util >= 30):
                sec_app_worth = 1
            elif(sec_app_fico_range_low < 500 and sec_app_revol_util < 30):
        ...
        #print(f"Dict Customer = {dict_customer}")
    ...
    def get_top_features_df(self, shap_values, feature_names, relevant_features, prediction, top_n=5):
        ...
        shap_dict_sorted = sorted(new_shap_dict.items(), key=lambda item : item[1])
